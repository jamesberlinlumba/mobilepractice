package ph.stacktrek.novare.ecommercenovare.james.lumba.dao
...
class DatabaseHandler(context: Context):
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME, $TABLE_PRODUCT_DESCRIPTION) values ('DOG FOOD', 'Food for dogs')")
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME, $TABLE_PRODUCT_DESCRIPTION) values ('CAT FOOD', 'Food for cats')")
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME, $TABLE_PRODUCT_DESCRIPTION) values ('RAT FOOD', 'Food for rats')")
    }
